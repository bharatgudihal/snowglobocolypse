...
#include "Core/snowglobocolypseGame.h"
...
{
    static char gameBuffer[sizeof(LYGame::snowglobocolypseGame)];

    ISystem* system = m_Framework->GetISystem();
    ModuleInitISystem(system, "snowglobocolypse");

    m_Game = new(reinterpret_cast<void*>(gameBuffer)) LYGame::snowglobocolypseGame();
